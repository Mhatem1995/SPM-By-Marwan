...
$qr_url = SPMBYMA_PLUGIN_URL . 'assets/instapay-qr.jpg';
?>

<div class="spm-support-card">
    <div class="spm-support-card__header">
        <h3 class="spm-support-card__title"><?php esc_html_e( 'Support Smart Plugin Monitor', 'smart-performance-monitor' ); ?></h3>
        <p class="spm-support-card__subtitle">
            <?php esc_html_e( 'Support ongoing development, security improvements, and future premium features.', 'smart-performance-monitor' ); ?>
        </p>
    </div>

    <div class="spm-support-card__qr">
        <img src="<?php echo esc_url( $qr_url ); ?>" alt="<?php esc_attr_e( 'Scan InstaPay QR', 'smart-performance-monitor' ); ?>">
        <span><?php esc_html_e( 'Scan InstaPay QR', 'smart-performance-monitor' ); ?></span>
    </div>
    ...
    <div class="spm-support-card__actions">
        <a href="https://ko-fi.com/marwanhatem31477" target="_blank" rel="noopener noreferrer" class="spm-btn spm-btn--kofi">
            ...
            <?php esc_html_e( 'Support via Ko-fi', 'smart-performance-monitor' ); ?>
        </a>
        <a href="https://ipn.eg/S/marwanhatem07/instapay/7wzFGM" target="_blank" rel="noopener noreferrer" class="spm-btn spm-btn--instapay">
            ...
            <?php esc_html_e( 'Support via InstaPay', 'smart-performance-monitor' ); ?>
        </a>
    </div>

    <footer class="spm-support-card__footer">
        <?php esc_html_e( 'Every contribution helps improve Smart Plugin Monitor faster ❤️', 'smart-performance-monitor' ); ?>
    </footer>
</div>
