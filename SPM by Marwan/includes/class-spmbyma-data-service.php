...
class SPMBYMA_Data_Service {
    ...
    private SPMBYMA_Performance_Analyzer $perf_analyzer;

    public function __construct( SPMBYMA_Database $database, SPMBYMA_Performance_Analyzer $perf_analyzer ) {
    ...
    public function get_dashboard_snapshot( int $days = self::PERIOD_7D ): array {
        global $wpdb;
        $table = SPMBYMA_Database::table_name();
    ...
    public static function resolve_period(): int {
        ...
        $val = isset( $_GET['spmbyma_period'] ) ? (int) $_GET['spmbyma_period'] : self::PERIOD_7D;
