...
class SPMBYMA_REST_Controller {
    ...
    private SPMBYMA_Action_Controller $action_controller;
    private SPMBYMA_Export_Service $export_service;
    private SPMBYMA_Analyzer $analyzer;
    private SPMBYMA_License_Detector $license_detector;
    private SPMBYMA_Security_Scanner $security_scanner;

    public function __construct(
        SPMBYMA_Detail_Provider $detail_provider,
        SPMBYMA_Data_Service $data_service,
        SPMBYMA_Action_Controller $action_controller,
        SPMBYMA_Export_Service $export_service,
        SPMBYMA_Analyzer $analyzer,
        SPMBYMA_License_Detector $license_detector,
        SPMBYMA_Security_Scanner $security_scanner
    ) {
    ...
    public function export_pdf(): void {
        ...
        wp_safe_redirect( admin_url( 'admin.php?page=spm-dashboard&spmbyma_view=print' ) );
        exit;
    }
}
