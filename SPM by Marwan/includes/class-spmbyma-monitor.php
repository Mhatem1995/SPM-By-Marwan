...
class SPMBYMA_Monitor {

    private SPMBYMA_Database $database;
    private SPMBYMA_Error_Handler $error_handler;
    private array $load_times = [];

    public function __construct( SPMBYMA_Database $database, SPMBYMA_Error_Handler $error_handler ) {
    ...
    private function measure_plugin_load_times(): void {
        ...
        foreach ( $active_plugins as $plugin_basename ) {
            ...
            // Skip ourselves.
            if ( plugin_basename( SPMBYMA_PLUGIN_FILE ) === $plugin_basename ) {
                continue;
            }
