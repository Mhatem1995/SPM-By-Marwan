...
class SPMBYMA_Analyzer {
    ...
    /**
     * @param SPMBYMA_Database $database
     * @param float        $slow_threshold_ms Override the default 500 ms threshold.
     */
    public function __construct( SPMBYMA_Database $database, float $slow_threshold_ms = self::DEFAULT_SLOW_THRESHOLD_MS ) {
