...
class SPMBYMA_Database {
    ...
    public static function table_name(): string {
        global $wpdb;
        return $wpdb->prefix . SPMBYMA_DB_TABLE;
    }
    ...
    public static function create_table(): void {
        ...
        update_option( 'spmbyma_db_version', SPMBYMA_VERSION );

        $logs_table = $wpdb->prefix . 'spmbyma_action_logs';
    ...
    public function log_action( string $plugin, string $action, string $result, string $details = '' ): bool {
        global $wpdb;
        $table = $wpdb->prefix . 'spmbyma_action_logs';
    ...
    public static function drop_table(): void {
        ...
        delete_option( 'spmbyma_db_version' );
    }
}
