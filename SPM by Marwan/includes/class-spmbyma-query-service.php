...
class SPMBYMA_Query_Service {
     ...
     *
     * Reads ?spmbyma_period=1|7|30, validates against allowed values,
     * defaults to 7 days.
     *
    ...
    public static function resolve_period(): int {
        ...
        $raw = isset( $_GET['spmbyma_period'] ) ? absint( $_GET['spmbyma_period'] ) : self::PERIOD_7D;
     ...
     */
    public function get_database(): SPMBYMA_Database {
     ...
     */
    public function get_analyzer(): SPMBYMA_Analyzer {
     ...
     */
    public function get_license_detector(): SPMBYMA_License_Detector {
